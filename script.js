$(document).ready(function() {
    ...
    box1.val(localStorage.getItem('Line1'));
    box2.val(localStorage.getItem('Line2'));
    box3.val(localStorage.getItem('Line3'));
    box4.val(localStorage.getItem('Line4'));
    box5.val(localStorage.getItem('Line5'));
    box9.val(localStorage.getItem('Line9'));
    box10.val(localStorage.getItem('Line10'));
    box11.val(localStorage.getItem('Line11'));
    box12.val(localStorage.getItem('Line12'));
    ...
    button9.on('click', function() {
        ...
        if (box9.val() !== '') {
            localStorage.setItem('Line9', box9.val());
        }
    });
    ...
    button10.on('click', function() {
        event.preventDefault();
        if (box10.val() !== '') {
         localStorage.setItem('Line10', box10.val());
        }
    ...
    button11.on('click', function() {
        event.preventDefault();
        if (box11.val() !== '') {
         localStorage.setItem('Line11', box11.val());
    ...
    button12.on('click', function() {
       event.preventDefault();
        if (box12.val() !== '') {
         localStorage.setItem('Line12', box12.val());
    ...
    button1.on('click', function() {
        event.preventDefault();
        if (box1.val() !== '') {
         localStorage.setItem('Line1', box1.val());
    ...
    button2.on('click', function() {
        event.preventDefault();
        if (box2.val() !== '') {
         localStorage.setItem('Line2', box2.val());
    ...
    button3.on('click', function() {
        event.preventDefault();
        if (box3.val() !== '') {
        localStorage.setItem('Line3', box3.val());
    ...
    button4.on('click', function() {
        ...
        if (box4.val() !== '') {
        localStorage.setItem('Line4', box4.val());
    ...
    button5.on('click', function() {
       event.preventDefault();
        ...
        if (box5.val() !== '') {
        localStorage.setItem('Line5', box5.val());
